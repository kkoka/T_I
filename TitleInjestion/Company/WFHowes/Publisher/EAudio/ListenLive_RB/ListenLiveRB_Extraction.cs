...
namespace TitleInjestion.Company.WFHowes.Publisher.EAudio.ListenLive_RB
{
    class ListenLiveRB_Extraction
    {
        public List<string> d101_productID = new List<string>();

        public bool ListenLive_RB_Extraction(TitleInjestion.Company.WFHowes.Onix_2_Short_Definition.ONIXmessage fileinfo_1, int pubid, string FileName, string MediaType,
        ...
        public bool Process_ListenLiveRB(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("WFH", ConfigurationSettings.AppSettings["WFH_Process_ListenLive_eAudio_RB"].ToString());
