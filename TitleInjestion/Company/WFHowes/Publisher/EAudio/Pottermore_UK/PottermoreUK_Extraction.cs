...
namespace TitleInjestion.Company.WFHowes.Publisher.EAudio.Pottermore_UK
{
    class PottermoreUK_Extraction
    {
        public List<string> d101_productID = new List<string>();

        public bool Pottermore_UK_Extraction(TitleInjestion.Company.WFHowes.Onix_2_Short_Definition.ONIXmessage fileinfo_1, int pubid, string FileName, string MediaType,
        ...
        public bool Process_PottermoreUK(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("WFH", ConfigurationSettings.AppSettings["WFH_Process_Pottermore_eAudio_UK"].ToString());
