...
namespace TitleInjestion.Company.WFHowes.Publisher.EAudio.LATheatreWorks_RB
{
    class LATheatreWorksRB_Extraction
    {
        public List<string> d101_productID = new List<string>();

        public bool LATheatreWorks_RB_Extraction(TitleInjestion.Company.WFHowes.Onix_2_Short_Definition.ONIXmessage fileinfo_1, int pubid, string FileName, string MediaType,
        ...
        public bool Process_LATheatreWorksRB(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("WFH", ConfigurationSettings.AppSettings["WFH_Process_LATheatreWorks_eAudio_RB"].ToString());
