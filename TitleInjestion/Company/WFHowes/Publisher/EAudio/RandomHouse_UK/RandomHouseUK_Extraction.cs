...
namespace TitleInjestion.Company.WFHowes.Publisher.EAudio.RandomHouse_UK
{
    class RandomHouseUK_Extraction
    {
        ...
        public bool Process_RandomHouseUK(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("WFH", ConfigurationSettings.AppSettings["WFH_Process_RandomHouse_eAudio_UK"].ToString());
