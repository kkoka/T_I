...
namespace TitleInjestion.Company.WFHowes.Publisher.EAudio.DorlingKindersley
{
    class DorlingKindersley_Extraction
    {
        public List<string> d101_productID = new List<string>();

        public bool DorlingKindersley_WFH_Extraction(TitleInjestion.Company.WFHowes.Onix_2_Short_Definition.ONIXmessage fileinfo_1, int pubid, string FileName, string MediaType,
        ...
        public bool Process_DorlingKindersley_WFH(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("WFH", ConfigurationSettings.AppSettings["WFH_Process_DorlingKindersley_eAudio_UK"].ToString());
                        ...
                        if (!string.IsNullOrEmpty(product.obj_b073_List[a].ToString()))
                        {
                            ...
                            if (Convert.ToInt32(product.obj_b073_List[a].ToString()) == 1)
                            {
                                Audience = "Adult";
                                     ...
                                     //Convert.ToInt32(product.obj_productaudience_List[a].b206_product.ToString()) == 2 ||
