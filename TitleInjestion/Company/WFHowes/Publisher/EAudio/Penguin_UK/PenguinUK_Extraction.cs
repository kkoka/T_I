...
namespace TitleInjestion.Company.WFHowes.Publisher.EAudio.Penguin_UK
{
    class PenguinUK_Extraction
    {
        ...
        public bool Process_PenguinUK(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("WFH", ConfigurationSettings.AppSettings["WFH_Process_Penguin_eAudio_UK"].ToString());
