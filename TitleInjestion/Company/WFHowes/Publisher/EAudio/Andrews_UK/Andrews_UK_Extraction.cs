...
namespace TitleInjestion.Company.WFHowes.Publisher.EAudio.Andrews_UK
{
    class Andrews_UK_Extraction
    {
        ...
        public bool Process_Andrews_UK(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("WFH", ConfigurationSettings.AppSettings["WFH_Process_Andrews_eAudio_UK"].ToString());
