...
namespace TitleInjestion.Company.WFHowes.Publisher.Ebook.Allen_Unwin
{
    class Allen_Unwin_Extraction
    {
        public List<string> d101_productID = new List<string>();

        public bool Allen_Unwin_UK_Extraction(int pubid, string FileName_Path, string FileName, string MediaType,
        ...
        public bool Process_Allen_UnwinUK(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("WFH", ConfigurationSettings.AppSettings["WFH_Process_Allen_Unwin_Ebook_UK"].ToString());
