...
namespace TitleInjestion.Company.WFHowes.Publisher.Ebook.Gingko
{
    class Gingko_Extraction
    {
        public List<string> d101_productID = new List<string>();

        public bool GingkoUK_Extraction(TitleInjestion.Company.WFHowes.Onix_2_Reference_Definiton.ONIXMessage fileinfo_1, int pubid, string FileName, string MediaType,
        ...
        public bool Process_Gingko(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("WFH", ConfigurationSettings.AppSettings["WFH_Process_Gingko_Ebook_UK"].ToString());
