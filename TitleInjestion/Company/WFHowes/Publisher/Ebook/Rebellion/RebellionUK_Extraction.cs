...
namespace TitleInjestion.Company.WFHowes.Publisher.Ebook.Rebellion
{
    class RebellionUK_Extraction
    {
        public List<string> d101_productID = new List<string>();

        public bool Rebellion_UK_Extraction(int pubid, string FileName_Path, string FileName, string MediaType,
        ...
        public bool Process_RebellionUK(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("WFH", ConfigurationSettings.AppSettings["WFH_Process_Rebellion_Ebook_UK"].ToString());
