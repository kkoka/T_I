...
namespace TitleInjestion.Company.WFHowes.Publisher.Ebook.SimonSchuster_UK
{
    class SimonSchuster_UK_Extraction
    {
        public List<string> d101_productID = new List<string>();

        public bool SimonSchusterUK_Extraction(TitleInjestion.Company.WFHowes.Onix_2_Short_Definition.ONIXmessage fileinfo_1, int pubid, string FileName, string MediaType,
        ...
        public bool Process_SimonSchuster_UK(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("WFH", ConfigurationSettings.AppSettings["WFH_Process_SimonSchuster_Ebook_UK"].ToString());
