...
namespace TitleInjestion.Company.WFHowes.Publisher.Ebook.SevernHouse
{
    class SevernHouseUK_Extraction
    {
        public List<string> d101_productID = new List<string>();

        public bool SevernHouse_UK_Extraction(TitleInjestion.Company.WFHowes.Onix_2_Short_Definition.ONIXmessage fileinfo_1, int pubid, string FileName, string MediaType,
        ...
        public bool Process_SevernHouseUK(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("WFH", ConfigurationSettings.AppSettings["WFH_Process_SevernHouse_Ebook_UK"].ToString());
