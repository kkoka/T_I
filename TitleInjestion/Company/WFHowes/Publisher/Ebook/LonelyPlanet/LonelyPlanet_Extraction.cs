...
namespace TitleInjestion.Company.WFHowes.Publisher.Ebook.LonelyPlanet
{
    class LonelyPlanet_Extraction
    {
        public List<string> d101_productID = new List<string>();

        public bool LonelyPlanetUK_Extraction(TitleInjestion.Company.WFHowes.Onix_2_Reference_Definiton.ONIXMessage fileinfo_1, int pubid, string FileName, string MediaType,
        ...
        public bool Process_LonelyPlanet(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("WFH", ConfigurationSettings.AppSettings["WFH_Process_LonelyPlanet_Ebook_UK"].ToString());
