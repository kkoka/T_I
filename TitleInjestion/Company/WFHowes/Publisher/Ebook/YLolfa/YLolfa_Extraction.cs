...
namespace TitleInjestion.Company.WFHowes.Publisher.Ebook.YLolfa
{
    class YLolfa_Extraction
    {
        public List<string> d101_productID = new List<string>();

        public bool YLolfa_UK_Extraction(int pubid, string FileName_Path, string FileName, string MediaType,
      ...
      #region 'Titles'
        ...
        public bool Process_YLolfanUK(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("WFH", ConfigurationSettings.AppSettings["WFH_Process_YLolfan_Ebook_UK"].ToString());
