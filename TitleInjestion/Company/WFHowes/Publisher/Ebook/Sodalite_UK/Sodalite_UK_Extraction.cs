...
namespace TitleInjestion.Company.WFHowes.Publisher.Ebook.Sodalite_UK
{
    class Sodalite_UK_Extraction
    {
        ...
        public bool Process_Sodalite_UK(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("WFH", ConfigurationSettings.AppSettings["WFH_Process_Sodalite_Ebook_UK"].ToString());
