...
namespace TitleInjestion.Company.WFHowes.Publisher.Ebook.Bloomsbury_UK
{
    class Bloomsbury_Extraction
    {
        ...
        public bool Bloomsbury_UK_Extraction(TitleInjestion.Onix_2_Short_Definition.ONIXmessage fileinfo_1, int pubid, string FileName, string MediaType,
        ...
        public DataTable Audience_b073(TitleInjestion.Onix_2_Short_Definition.product product, DataTable dt_Audience_b073, int MetaDataID, int productCount)
        {
            //dr["FileName"] = fileinfo_1.obj_FileInfo_List[0].FileName_FileInfo;
            //dr["pubId"] = fileinfo_1.obj_FileInfo_List[0].PubID_FileInfo;
            //dr["FileType"] = fileinfo_1.obj_FileInfo_List[0].FileType_FileInfo;
