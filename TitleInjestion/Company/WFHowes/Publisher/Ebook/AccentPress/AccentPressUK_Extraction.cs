...
namespace TitleInjestion.Company.WFHowes.Publisher.Ebook.AccentPress
{
    class AccentPressUK_Extraction
    {
        public List<string> d101_productID = new List<string>();

        public bool AccentPress_UK_Extraction(TitleInjestion.Company.WFHowes.Onix_2_Short_Definition.ONIXmessage fileinfo_1, int pubid, string FileName, string MediaType,
        ...
        public bool Process_AccentPressUK(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("WFH", ConfigurationSettings.AppSettings["WFH_Process_AccentPress_Ebook_UK"].ToString());
        ...
        public DataTable Imprint(TitleInjestion.Company.WFHowes.Onix_2_Short_Definition.product product, DataTable dt_Imprint, int MetaDataID, int productCount)
        {
            ...
            for (int a = 0; a < product.obj_imprint_List.Count; a++)
            {
                ...
                //{
                //    if (product.obj_imprint_List[a].b241_product_imprint == "02")
                //    {
