...
namespace TitleInjestion.Company.WFHowes.Publisher.Ebook.Alnpete_Limited
{
    class AlnpeteLimited_Extraction
    {

        public List<string> d101_productID = new List<string>();

        public bool AlnpeteLimited_UK_Extraction(int pubid, string FileName_Path, string FileName, string MediaType,
        ...
        public bool Process_AlnpeteLimitedUK(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("WFH", ConfigurationSettings.AppSettings["WFH_Process_AlnpeteLimited_Ebook_UK"].ToString());
