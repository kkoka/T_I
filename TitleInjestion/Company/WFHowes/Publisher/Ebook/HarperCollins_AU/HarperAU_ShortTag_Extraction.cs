...
namespace TitleInjestion.Company.WFHowes.Publisher.Ebook.HarperCollins_AU
{
    class HarperAU_ShortTag_Extraction
    {
        public List<string> d101_productID = new List<string>();

        public bool Harper_AU_Extraction(TitleInjestion.Company.WFHowes.Onix_2_Short_Definition.ONIXmessage fileinfo_1, int pubid, string FileName, string MediaType,
            ...
            for (int a = 0; a < product.obj_product_supplydetail_List.Count; a++)
            {
                for (int b = 0; b < product.obj_product_supplydetail_List[a].obj_supplydetail_price_List.Count; b++)
                {
                    ...
                    if (product.obj_product_supplydetail_List[a].obj_supplydetail_price_List[b].j152_product_supplydetail_price.ToLower() == "gbp")
                    {
                        ...
                        {
                            if (product.obj_product_supplydetail_List[a].obj_supplydetail_price_List[b].j261_product_supplydetail_price.ToLower() == "00")
                            {
