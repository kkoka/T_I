    ...
    class HarperAU_Extraction
    {
       ...
       public void Insertion_Label(System.Windows.Forms.Label lbl_Insertion, int count)
        ...
        public bool Process_HarperAU(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("WFH", ConfigurationSettings.AppSettings["WFH_Process_Harper_Ebook_AU"].ToString());
        ...
        public DataTable Imprint(TitleInjestion.Company.WFHowes.Onix_2_Reference_Definiton.Product product, DataTable dt_RH_Imprint, int MetaDataID, int productCount)
        {
            ...
            for (int a = 0; a < product.obj_ProductImprint_List.Count; a++)
            {
                ...
                //if (string.IsNullOrEmpty(product.obj_ProductImprint_List[a].b241_product_imprint))
                //{
                                    ...
                                    if (product.obj_ProductSupplyDetail_List[a].obj_ProductSupplyDetailPrice_List[b].PriceTypeCode_ProductSupplyDetailPrice.ToLower() == "02")
                                    {
                                        ...
                                        for (int c = 0; c < product.obj_ProductSupplyDetail_List[a].obj_ProductSupplyDetailPrice_List[b].obj_ProductSupplyDetailPriceCountryCode_List.Count; c++)
                                        {
                                            if (product.obj_ProductSupplyDetail_List[a].obj_ProductSupplyDetailPrice_List[b].obj_ProductSupplyDetailPriceCountryCode_List[c].ToString().ToLower() == "au" )
                                                //|| product.obj_ProductSupplyDetail_List[a].obj_ProductSupplyDetailPrice_List[b].obj_ProductSupplyDetailPriceCountryCode_List[c].ToString().ToLower() == "nz")
                                            {
