...
namespace TitleInjestion.Company.WFHowes.Publisher.Ebook.Macmillan_AU
{
    class MacmillanAU_Extraction
    {
        public List<string> d101_productID = new List<string>();


        public bool Macmillan_AU_Extraction(TitleInjestion.Company.WFHowes.Onix_2_Short_Definition.ONIXmessage fileinfo_1, int pubid, string FileName, string MediaType,
        ...
        public bool Process_Macmillan_AU(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("WFH", ConfigurationSettings.AppSettings["WFH_Process_Macmillan_Ebook_AU"].ToString());
