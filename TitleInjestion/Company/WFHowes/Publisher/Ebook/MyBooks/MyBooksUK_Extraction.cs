...
namespace TitleInjestion.Company.WFHowes.Publisher.Ebook.MyBooks
{
    class MyBooksUK_Extraction
    {
        public List<string> d101_productID = new List<string>();

        public bool MyBooks_Extraction(TitleInjestion.Company.WFHowes.Onix_2_Reference_Definiton.ONIXMessage fileinfo_1, int pubid, string FileName, string MediaType,
        ...
        public bool Process_MyBooks(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("WFH", ConfigurationSettings.AppSettings["WFH_Process_MyBooks_Ebook_UK"].ToString());
