...
namespace TitleInjestion.Company.WFHowes.Publisher.Ebook.RandomHouse_AU
{
    class RandomHouse_AU_Extraction
    {
        public List<string> d101_productID = new List<string>();

        public bool RandomHouseAU_Extraction(TitleInjestion.Company.WFHowes.Onix_2_Short_Definition.ONIXmessage fileinfo_1, int pubid, string FileName, string MediaType,
        ...
        public bool Process_RandomHouse_AU(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("WFH", ConfigurationSettings.AppSettings["WFH_Process_RandomHouse_Ebook_AU"].ToString());
