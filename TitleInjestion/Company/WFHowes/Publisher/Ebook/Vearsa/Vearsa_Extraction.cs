...
namespace TitleInjestion.Company.WFHowes.Publisher.Ebook.Vearsa
{
    class Vearsa_Extraction
    {
        public List<string> d101_productID = new List<string>();

        public bool Vearsa_UK_Extraction(TitleInjestion.Company.WFHowes.Onix_2_Reference_Definiton.ONIXMessage fileinfo_1, int pubid, string FileName, string MediaType,
        ...
        public bool Process_VearsaUK(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("WFH", ConfigurationSettings.AppSettings["WFH_Process_Vearsa_Ebook_UK"].ToString());
