...
namespace TitleInjestion.Company.WFHowes.Publisher.Ebook.BeyondThePage
{
    class BeyondThePage_UK_Extraction
    {
        public List<string> d101_productID = new List<string>();

        public bool BeyondThePageUK_Extraction(int pubid, string FileName_Path, string FileName, string MediaType,
        ...
        public bool Process_BeyondThePage_UK(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("WFH", ConfigurationSettings.AppSettings["WFH_Process_BeyondThePage_Ebook_UK"].ToString());
