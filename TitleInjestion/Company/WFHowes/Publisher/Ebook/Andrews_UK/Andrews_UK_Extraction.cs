...
namespace TitleInjestion.Company.WFHowes.Publisher.Ebook.Andrews_UK
{
    class Andrews_UK_Extraction
    {
        public List<string> d101_productID = new List<string>();

        public bool AndrewsUK_Extraction(int pubid, string FileName_Path, string FileName, string MediaType,
        ...
        public bool Process_Andrews_UK(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("WFH", ConfigurationSettings.AppSettings["WFH_Process_Andrews_Ebook_UK"].ToString());
