...
namespace TitleInjestion.Company.RecordedBooks
{
    class Onix_CleanUP
    {
        ...
        string cleanedupFilePath = ConfigurationSettings.AppSettings["RB_cleanedupFilePath"].ToString();
        ...
        public string ReferenceTags_ShortTags_Translation(string xmlText)
        {
            ...
            xmlText = xmlText.Replace("<b044>", "<b044><![CDATA[").Replace("<b044><![CDATA[<![CDATA[", "<b044><![CDATA[").Replace("</b044>", "]]></b044>").Replace("]]>]]></b044>", "]]></b044>").Replace("<b044 textformat=\"05\">", "<b044 textformat=\"05\"><![CDATA[").Replace("<b044 textformat=\"05\"><![CDATA[<![CDATA[", "<b044 textformat=\"05\"><![CDATA[");
            ...
            xmlText = xmlText.Replace("<d104>", "<d104><![CDATA[").Replace("<d104><![CDATA[<![CDATA[", "<d104><![CDATA[").Replace("<d104 textformat=\"05\">", "<d104 textformat=\"05\"><![CDATA[").Replace("<d104 textformat=\"05\"><![CDATA[<![CDATA[", "<d104 textformat=\"05\"><![CDATA[").Replace("</d104>", "]]></d104>").Replace("]]>]]></d104>", "]]></d104>");
            ...
            xmlText = xmlText.Replace("<d104  textformat=\"06\">", "<d104 textformat=\"06\"><![CDATA[").Replace("<d104 textformat=\"06\">", "<d104 textformat=\"02\"><![CDATA[").Replace("<d104 textformat=\"06\"><![CDATA[<![CDATA[", "<d104 textformat=\"06\"><![CDATA[");
            xmlText = xmlText.Replace("<d104  textformat=\"06\" language=\"eng\">", "<d104 textformat=\"06\" language=\"eng\"><![CDATA[").Replace("<d104 textformat=\"06\" language=\"eng\">", "<d104 textformat=\"06\" language=\"eng\"><![CDATA[").Replace("<d104 textformat=\"06\" language=\"eng\"><![CDATA[<![CDATA[", "<d104 textformat=\"06\" language=\"eng\"><![CDATA[");
        ...
        public string CleanUP_LargeXMLFiles(FileInfo file, string Company) //, string fullfilepath_Sortfile)
        {
            ...
            {
                CommonFunctions.SQLFunction sqlfunction = new CommonFunctions.SQLFunction();
        ...
        public string CleanUP_LargeXMLFiles(FileInfo file, string Company, string MediaType, string PublisherName) //, string fullfilepath_Sortfile)
        {
            try
            {
                if (file.Exists)
                {
                    ...
                    using (StreamWriter sw1 = new StreamWriter(cleanedupFilePath + file.Name))
                    {
                        ...
                        using (StreamReader sr = new StreamReader(file.FullName))
                        {
                            while (sr.Peek() >= 0)
                            {
                                if(MediaType.ToLower()=="ebook" && PublisherName.ToLower() == "harlequin")
                                {
                                    //Console.WriteLine(sr.ReadLine());
                                    sw1.WriteLine(SanitizeXmlString(sr.ReadLine()));
                                }
                                else
                                { 
                                    //Console.WriteLine(sr.ReadLine());
