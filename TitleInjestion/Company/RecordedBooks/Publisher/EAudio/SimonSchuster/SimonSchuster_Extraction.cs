...
namespace TitleInjestion.Company.RecordedBooks.Publisher.EAudio.SimonSchuster
{
    class SimonSchuster_Extraction
    {
        public List<string> d101_productID = new List<string>();

        public bool RB_SimonSchuster_Extraction(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.ONIXmessage fileinfo_1, int pubid, string FileName, string MediaType,
        ...
        public bool Process_SimonSchuster_EAudio(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("RB", ConfigurationSettings.AppSettings["RB_Process_SimonSchuster_EAudio"].ToString());
        ...
        public DataTable ISBN(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_ISBN, int MetaDataID, int productCount)
        {
            ...
            for (int a = 0; a < product.obj_product_productidentifier_List.Count; a++)
            {
                ...
                {
                    i++;
                    if(product.obj_product_productidentifier_List[a].b244_product_productidentifier =="9781508245360")
                    {
                        string asdfa = "asdfasd";
