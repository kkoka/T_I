...
namespace TitleInjestion.Company.RecordedBooks.Publisher.EAudio.Oasis
{
    class Oasis_Extraction
    {
        public List<string> d101_productID = new List<string>();

        public bool RB_Oasis_Extraction(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.ONIXmessage fileinfo_1, int pubid, string FileName, string MediaType,
        ...
        public bool Process_Oasis_EAudio(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("RB", ConfigurationSettings.AppSettings["RB_Process_Oasis_EAudio"].ToString());
        ...
        public DataTable Publisher(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_Publisher, int MetaDataID, int productCount)
        {
            ...
            //{
                ...
                dr["ProductID"] = productCount;
                dr["RowCnt"] = 1;
                dr["Publisher_b081"] = "Oasis Audio"; // product.obj_product_publisher_List[a].b081_product_publisher;
