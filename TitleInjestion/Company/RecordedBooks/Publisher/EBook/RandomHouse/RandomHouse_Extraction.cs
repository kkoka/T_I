...
namespace TitleInjestion.Company.RecordedBooks.Publisher.EBook.RandomHouse
{
    class RandomHouse_Extraction
    {

        public List<string> d101_productID = new List<string>();

        public bool RB_RandomHouse_Extraction(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.ONIXmessage fileinfo_1, int pubid, string FileName, string MediaType,
        ...
        public bool Process_RandomHouse(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("RB", ConfigurationSettings.AppSettings["RB_Process_RH_Ebook"].ToString());
