...
namespace TitleInjestion.Company.RecordedBooks.Publisher.EBook.CoreSourcePlus30
{
    class CoreSourcePlus30_Extraction
    {
        public List<string> d101_productID = new List<string>();

        public bool RB_CoreSourcePlus30_Extraction(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.ONIXmessage fileinfo_1, int pubid, string FileName, string MediaType,
        ...
        public bool Process_CoreSourcePlus30(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("RB", ConfigurationSettings.AppSettings["RB_Process_CoreSourcePlus30_Ebook"].ToString());
