...
namespace TitleInjestion.Company.RecordedBooks.Publisher.EBook.CoreSourcePlus40
{
    class CoreSourcePlus40_Extraction
    {
        public List<string> d101_productID = new List<string>();

        public bool RB_CoreSourcePlus40_Extraction(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.ONIXmessage fileinfo_1, int pubid, string FileName, string MediaType,
        ...
        public bool Process_CoreSourcePlus40(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("RB", ConfigurationSettings.AppSettings["RB_Process_CoreSourcePlus40_Ebook"].ToString());
