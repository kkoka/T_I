...
namespace TitleInjestion.Company.RecordedBooks.Publisher.EBook.ChildsWorld
{
    class ChildsWorld_Extraction
    {
        public List<string> d101_productID = new List<string>();

        public bool RB_ChildsWorld_Extraction(TitleInjestion.Company.RecordedBooks.Onix_2_Reference_Definiton.ONIXMessage fileinfo_1, int pubid, string FileName, string MediaType,
        ...
        public bool Process_ChildsWorld(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("RB", ConfigurationSettings.AppSettings["RB_Process_ChildsWorld_Ebook"].ToString());
