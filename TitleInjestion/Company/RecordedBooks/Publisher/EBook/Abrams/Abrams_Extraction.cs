...
namespace TitleInjestion.Company.RecordedBooks.Publisher.EBook.Abrams
{
    class Abrams_Extraction
    {

        public List<string> d101_productID = new List<string>();

        public bool RB_Abrams_Extraction(TitleInjestion.Company.RecordedBooks.Onix_2_Reference_Definiton.ONIXMessage fileinfo_1, int pubid, string FileName, string MediaType,
        ...
        public bool Process_Abrams(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("RB", ConfigurationSettings.AppSettings["RB_Process_Abrams_Ebook"].ToString());
