...
namespace TitleInjestion.Company.RecordedBooks.Publisher.EBook.SimonSchuster
{
    class SimonSchuster_Extraction
    {
        ...
        public bool Process_SimonSchuster(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("RB", ConfigurationSettings.AppSettings["RB_Process_SimonSchuster_Ebook"].ToString());
