...
{
    class HarperAU_Extraction
    {
        public List<string> d101_productID = new List<string>();

        public bool RB_HarperAU_Extraction(TitleInjestion.Company.RecordedBooks.Onix_2_Reference_Definiton.ONIXMessage fileinfo_1, int pubid, string FileName, string MediaType,
                    ...
                    if (product.obj_product_SupplyDetail_List[a].obj_product_SupplyDetail_Price_List[b].CurrencyCode_ProductSupplyDetailPrice.ToLower() == "usd")
                    {
                        if (!string.IsNullOrEmpty(product.obj_product_SupplyDetail_List[a].obj_product_SupplyDetail_Price_List[b].PriceQualifier_ProductSupplyDetailPrice))
                        {
                            if (product.obj_product_SupplyDetail_List[a].obj_product_SupplyDetail_Price_List[b].PriceQualifier_ProductSupplyDetailPrice.ToLower() == "06")
                            {
                                ...
                                {
                                    if (product.obj_product_SupplyDetail_List[a].obj_product_SupplyDetail_Price_List[b].PriceTypeCode_ProductSupplyDetailPrice.ToLower() == "01")
                                    {
            ...
            for (int a = 0; a < product.obj_Product_ProductFormDetail_List.Count; a++)
            {
                ...
                if (!string.IsNullOrEmpty(product.obj_Product_ProductFormDetail_List[a]))
                {
                    ...
                    if (product.obj_Product_ProductFormDetail_List[a].ToString().ToLower() == "e200")
                    {
                        ...
                        || product.obj_Product_ProductFormDetail_List[a].ToString().ToLower() == "e202"
                        || product.obj_Product_ProductFormDetail_List[a].ToString().ToLower() == "e210"
                        || product.obj_Product_ProductFormDetail_List[a].ToString().ToLower() == "e211"
                        || product.obj_Product_ProductFormDetail_List[a].ToString().ToLower() == "e221"
                        || product.obj_Product_ProductFormDetail_List[a].ToString().ToLower() == "e222"
                        || product.obj_Product_ProductFormDetail_List[a].ToString().ToLower() == "e223"
                        || product.obj_Product_ProductFormDetail_List[a].ToString().ToLower() == "e224"
                        || product.obj_Product_ProductFormDetail_List[a].ToString().ToLower() == "e225"
                        )
                    {
                        //string asdf = product.obj_product_othertext_List[a].d104_product_othertext.Substring(0, 3500);
                        // dr["DigitalFormat_b333"] = product.obj_b333_List[a]; 
                    ...
                    else
                    {
                        ...
                        {
                            dr["DigitalFormat_b333"] = "Reflowable"; // product.obj_Product_ProductFormDetail_List[a].Trim();
                        }
                        else
                        {
                            dr["DigitalFormat_b333"] = "";
        ...
        //////public DataTable b211(TitleInjestion.Company.RecordedBooks.Onix_2_Reference_Definiton.Product product, DataTable dt_RH_b211, int productCount)
        //////{
