...
{
    class Tyndale_shorttag_Extraction
    {
        public List<string> d101_productID = new List<string>();

        public bool RB_Tyndaleshorttag_Extraction(TitleInjestion.Company.RecordedBooks.Onix_3_Short_Definition.ONIXmessage fileinfo_1, int pubid, string FileName, string MediaType,
            ...
            try
            {
                ...
                if (MetaDataID > 0)
                {
                    for (int i = 0; i < fileinfo_1.obj_product_List.Count; i++)
                    {
                        ...
                        #region 'TotalRunTime - commented out'
                        ...
                        #region 'ProductFormCode_b012 - commented out'
        ...
        public DataTable ISBN(TitleInjestion.Company.RecordedBooks.Onix_3_Short_Definition.product product, DataTable dt_ISBN, int MetaDataID, int productCount)
        {
            ...
            for (int a = 0; a < product.obj_productproductidentifier_List.Count; a++)
            {
                if (product.obj_productproductidentifier_List[a].b221_product_productidentifier == "15")
                {
                    ...
                    //if(product.obj_productproductidentifier_List[a].b244_product_productidentifier == "9781604829150")
                    //{
                    //    string asdfd = "asdfsaddasfdsfd";
                    //}
                    break;
                }
            }
        ...
        public DataTable Publisher(TitleInjestion.Company.RecordedBooks.Onix_3_Short_Definition.product product, DataTable dt_Publisher, int MetaDataID, int productCount)
        {
            ...
            dr["ProductID"] = productCount;
            dr["RowCnt"] = "1";
            dr["Publisher_b081"] = product.obj_productpublishingdetail_List[a].obj_productpublishingdetail_publisher_List[b].b081;
        ...
        public DataTable Imprint(TitleInjestion.Company.RecordedBooks.Onix_3_Short_Definition.product product, DataTable dt_Imprint, int MetaDataID, int productCount)
        {
            ...
            for (int a = 0; a < product.obj_productpublishingdetail_List.Count; a++)
            {
                for (int b = 0; b < product.obj_productpublishingdetail_List[a].obj_productpublishingdetail_imprint_List.Count; b++)
                {
                    DataRow dr = dt_Imprint.NewRow();
                    ...
                    dr["ProductID"] = productCount;
                    dr["RowCnt"] = "1";
                    dr["Imprint_b079"] = product.obj_productpublishingdetail_List[a].obj_productpublishingdetail_imprint_List[b].b079;
                ...
                for (int b = 0; b < product.obj_productdescriptivedetail_List[a].obj_product_descriptivedetail_audience_List.Count; b++)
                {
                    for (int c = 0; c < product.obj_productdescriptivedetail_List[a].obj_product_descriptivedetail_audience_List[b].obj_b206_productdescriptivedetail_audience_List.Count; b++)
                    {
                        if (!string.IsNullOrEmpty(product.obj_productdescriptivedetail_List[a].obj_product_descriptivedetail_audience_List[b].obj_b206_productdescriptivedetail_audience_List[c]))
                        {
                            ...
                            {
                                dr["AudienceCode_b206"] = product.obj_productdescriptivedetail_List[a].obj_product_descriptivedetail_audience_List[b].obj_b206_productdescriptivedetail_audience_List[c];
                            }
                            //if (b206 == "adult")
                            //{
                            //    dr["AudienceCode_b206"] = "Adult";
                ...
                for (int b = 0; b < product.obj_productpublishingdetail_List[a].obj_productpublishingdetail_salesrights_List.Count; b++)
                {
                    if (!string.IsNullOrEmpty(product.obj_productpublishingdetail_List[a].obj_productpublishingdetail_salesrights_List[b].b089))
                    {
                            ...
                            )
                        {
                            ...
                            #region ''
                            string territory = "";
                            for (int j = 0; j < product.obj_productpublishingdetail_List[a].obj_productpublishingdetail_salesrights_List[b].obj_productpublishingdetail_salesrights_territory_List.Count; j++)
                            {

                                //   if (!string.IsNullOrEmpty(product.obj_productpublishingdetail_List[a].obj_productpublishingdetail_salesrights_List[b].obj_productpublishingdetail_salesrights_territory_List[j].obj_x449_List.))
                                if ((product.obj_productpublishingdetail_List[a].obj_productpublishingdetail_salesrights_List[b].obj_productpublishingdetail_salesrights_territory_List[j].obj_x449_List != null) )
                                    //&& (!product.obj_productpublishingdetail_List[a].obj_productpublishingdetail_salesrights_List[b].obj_productpublishingdetail_salesrights_territory_List[j].obj_x449_List.Any()))
                                {
                                    for (int i = 0; i < product.obj_productpublishingdetail_List[a].obj_productpublishingdetail_salesrights_List[b].obj_productpublishingdetail_salesrights_territory_List[j].obj_x449_List.Count; i++)
                                    {
                                        territory += product.obj_productpublishingdetail_List[a].obj_productpublishingdetail_salesrights_List[b].obj_productpublishingdetail_salesrights_territory_List[j].obj_x449_List[i];
                                    }
                                }

                                if ((product.obj_productpublishingdetail_List[a].obj_productpublishingdetail_salesrights_List[b].obj_productpublishingdetail_salesrights_territory_List[j].obj_x450_List != null) )
                                    //&& (!product.obj_productpublishingdetail_List[a].obj_productpublishingdetail_salesrights_List[b].obj_productpublishingdetail_salesrights_territory_List[j].obj_x450_List.Any()))
                                {
                                    for (int i = 0; i < product.obj_productpublishingdetail_List[a].obj_productpublishingdetail_salesrights_List[b].obj_productpublishingdetail_salesrights_territory_List[j].obj_x450_List.Count; i++)
                                    {
                                        territory += product.obj_productpublishingdetail_List[a].obj_productpublishingdetail_salesrights_List[b].obj_productpublishingdetail_salesrights_territory_List[j].obj_x450_List[i];
                                    }
                                }
                                ...
                                //<b089>01</b089>
                                //<territory>
                                //   <x449>AS CA GU MP PR UM US VI</x449>
                                //</territory>
                            }
                            #endregion
