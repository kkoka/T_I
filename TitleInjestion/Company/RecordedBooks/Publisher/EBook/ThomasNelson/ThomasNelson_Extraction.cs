...
namespace TitleInjestion.Company.RecordedBooks.Publisher.EBook.ThomasNelson
{
    class ThomasNelson_Extraction
    {
        ...
        public bool Process_ThomasNelson(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("RB", ConfigurationSettings.AppSettings["RB_Process_ThomasNelson_Ebook"].ToString());
