...
namespace TitleInjestion.Company.RecordedBooks.Publisher.EBook.Zondervan
{
    class Zondervan_Extraction
    {
        ...
        public bool Process_Zondervan(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("RB", ConfigurationSettings.AppSettings["RB_Process_Zondervan_Ebook"].ToString());
