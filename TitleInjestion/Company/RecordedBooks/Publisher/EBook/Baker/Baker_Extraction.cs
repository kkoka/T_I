...
namespace TitleInjestion.Company.RecordedBooks.Publisher.EBook.Baker
{
    class Baker_Extraction
    {

        public List<string> d101_productID = new List<string>();

        public bool RB_Baker_Extraction(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.ONIXmessage fileinfo_1, int pubid, string FileName, string MediaType,
           ...
           System.Windows.Forms.Label lbl_Message)
        {
            ...
            try
            {
                ...
                #region 'Columns Declaration'
                dt_Publisher2.Columns.Add("MetaDataID", typeof(int));
                ...
                if (MetaDataID > 0)
                {
                    ...
                    if (result)
                    {
                        result = InsertRecords(dt_Publisher2, "RB");
                        Insertion_Label(lbl_Insert, count);
                    }
                    count--;
        ...
        public bool Process_Baker(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("RB", ConfigurationSettings.AppSettings["RB_Process_Baker_Ebook"].ToString());
