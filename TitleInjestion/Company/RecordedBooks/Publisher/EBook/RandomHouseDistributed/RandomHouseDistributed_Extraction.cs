...
namespace TitleInjestion.Company.RecordedBooks.Publisher.EBook.RandomHouseDistributed
{
    class RandomHouseDistributed_Extraction
    {

        public List<string> d101_productID = new List<string>();

        public bool RB_RandomHouseDistributed_Extraction(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.ONIXmessage fileinfo_1, int pubid, string FileName, string MediaType,
        ...
        public bool Process_RandomHouseDistributed(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("RB", ConfigurationSettings.AppSettings["RB_Process_RandomHouseDistributed_Ebook"].ToString());
        ...
        //public DataTable b213(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_b213, int MetaDataID, int productCount)
        //{
        ...
        public DataTable ISBN(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_ISBN, int MetaDataID, int productCount)
        {
        ...
        public DataTable TitleSubtitle(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_Title_Subtitle, int MetaDataID, int productCount)
        {
        ...
        public DataTable Publisher(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_Publisher, int MetaDataID, int productCount)
        {
        ...
        //public DataTable Publisher2(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_Publisher2, int MetaDataID, int productCount)
        //{
        ...
        public DataTable Imprint(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_Imprint, int MetaDataID, int productCount)
        {
        ...
        public DataTable UnAbridged(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_UnAbridged, int MetaDataID, int productCount)
        {
        ...
        public DataTable Language(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_Language, int MetaDataID, int productCount)
        {
        ...
        public DataTable Price(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_Price, int MetaDataID, int productCount)
        {
        ...
        public DataTable Description_d101(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_Description_d101, int MetaDataID, int productCount)
        {
        ...
        public DataTable Description(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_Description, int MetaDataID, int productCount)
        {
        ...
        public DataTable Contributor(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_contributor, int MetaDataID, int productCount)
        {
        ...
        //public DataTable DigitalFormat_b333(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_DigitalFormat_b333, int MetaDataID, int productCount)
        //{
        ...
        public DataTable Bisac(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_Bisac, int MetaDataID, int productCount)
        {
            //dr["FileName"] = fileinfo_1.obj_FileInfo_List[0].FileName_FileInfo;
            //dr["pubId"] = fileinfo_1.obj_FileInfo_List[0].PubID_FileInfo;
            //dr["FileType"] = fileinfo_1.obj_FileInfo_List[0].FileType_FileInfo;
        ...
        public DataTable MainBisacBic(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_MainBisacBic, int MetaDataID, int productCount)
        {
            //dr["FileName"] = fileinfo_1.obj_FileInfo_List[0].FileName_FileInfo;
            //dr["pubId"] = fileinfo_1.obj_FileInfo_List[0].PubID_FileInfo;
            //dr["FileType"] = fileinfo_1.obj_FileInfo_List[0].FileType_FileInfo;
        ...
        //public DataTable Audience(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_Audience, int MetaDataID, int productCount)
        //{
        //    //dr["FileName"] = fileinfo_1.obj_FileInfo_List[0].FileName_FileInfo;
        //    //dr["pubId"] = fileinfo_1.obj_FileInfo_List[0].PubID_FileInfo;
        //    //dr["FileType"] = fileinfo_1.obj_FileInfo_List[0].FileType_FileInfo;
        ...
        //}
        public DataTable AudienceCode_b073(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_AudienceCode_b073, int MetaDataID, int productCount)
        {
        ...
        public DataTable AudienceCode_b206(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_AudienceCode_b206, int MetaDataID, int productCount)
        {
        ...
        //public DataTable MinAge(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_MinAge, int MetaDataID, int productCount)
        //{
        //    //dr["FileName"] = fileinfo_1.obj_FileInfo_List[0].FileName_FileInfo;
        //    //dr["pubId"] = fileinfo_1.obj_FileInfo_List[0].PubID_FileInfo;
        //    //dr["FileType"] = fileinfo_1.obj_FileInfo_List[0].FileType_FileInfo;
        ...
        //    return dt_RH_MinAge;
        //}
        public DataTable Series(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_Series, int MetaDataID, int productCount)
        {
        ...
        public DataTable Status_b394(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_Status_b394, int MetaDataID, int productCount)
        {
        ...
        public DataTable Status_j141(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_Status_j141, int MetaDataID, int productCount)
        {
        ...
        public DataTable SalesRights(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_SalesRights, int MetaDataID, int productCount)
        {
            //dr["FileName"] = fileinfo_1.obj_FileInfo_List[0].FileName_FileInfo;
            //dr["pubId"] = fileinfo_1.obj_FileInfo_List[0].PubID_FileInfo;
            //dr["FileType"] = fileinfo_1.obj_FileInfo_List[0].FileType_FileInfo;
        ...
        public DataTable SalesRights_NotForSale(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_SalesRights_NotForSale, int MetaDataID, int productCount)
        {
        ...
        public DataTable PageCount(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_SalesRights, int MetaDataID, int productCount)
        {
        ...
        //public DataTable SalesRestriction(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_SalesRestriction, int MetaDataID, int productCount)
        //{
        ...
        //}
        public DataTable ReleaseDate_b003(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_ReleaseDate_b003, int MetaDataID, int productCount)
        {
        ...
        public DataTable ReleaseDate_j143(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_ReleaseDate_j143, int MetaDataID, int productCount)
        {
        ...
        public DataTable EditionNumber_b057(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_EditionNumber_b057, int MetaDataID, int productCount)
        {
            //dr["FileName"] = fileinfo_1.obj_FileInfo_List[0].FileName_FileInfo;
            //dr["pubId"] = fileinfo_1.obj_FileInfo_List[0].PubID_FileInfo;
            //dr["FileType"] = fileinfo_1.obj_FileInfo_List[0].FileType_FileInfo;
        ...
        public DataTable ProductFormCode_b012(TitleInjestion.Company.RecordedBooks.Onix_2_Short_Definition.product product, DataTable dt_RH_ProductFormCode_b012, int MetaDataID, int productCount)
        {
