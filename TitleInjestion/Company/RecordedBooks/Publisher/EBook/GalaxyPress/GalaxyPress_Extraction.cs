...
namespace TitleInjestion.Company.RecordedBooks.Publisher.EBook.GalaxyPress
{
    class GalaxyPress_Extraction
    {
        ...
        public bool Process_GalaxyPress(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("RB", ConfigurationSettings.AppSettings["RB_Process_GalaxyPress_Ebook"].ToString());
