...
namespace TitleInjestion.Company.RecordedBooks.Publisher.EBook.Lerner
{
    class Lerner_Extraction
    {
        ...
        public bool Process_Lerner(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("RB", ConfigurationSettings.AppSettings["RB_Process_Lerner_Ebook"].ToString());
