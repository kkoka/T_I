...
namespace TitleInjestion.Company.RecordedBooks.Publisher.EBook.NorthStar
{
    class NorthStar_Extraction
    {
        public bool RB_NorthStar_Extraction(TitleInjestion.Company.RecordedBooks.Onix_3_Short_Definition.ONIXmessage fileinfo_1, int pubid, string FileName, string MediaType,
      ...
      System.Windows.Forms.Label lbl_Message)
        ...
        public bool Process_NorthStar_EBook(string Company, System.Windows.Forms.Label lbl_Processing)
        {
            bool result = false;
            ...
            SQLFunction sqlfunction = new SQLFunction();
            result = sqlfunction.ExecuteProc("RB", ConfigurationSettings.AppSettings["RB_ProcessNorthStar_Ebook"].ToString());
                    ...
                    if (!string.IsNullOrEmpty(product.obj_productpublishingdetail_List[a].obj_productpublishingdetail_salesrights_List[b].b089))
                    {
                           ...
                           )
                        {
                            for (int c = 0; c < product.obj_productpublishingdetail_List[a].obj_productpublishingdetail_salesrights_List[b].obj_productpublishingdetail_salesrights_territory_List.Count; c++)
                            {
                                ...
                                for (int d = 0; d < product.obj_productpublishingdetail_List[a].obj_productpublishingdetail_salesrights_List[b].obj_productpublishingdetail_salesrights_territory_List[c].obj_x450_List.Count; d++)
                                {
                                    if (!string.IsNullOrEmpty(product.obj_productpublishingdetail_List[a].obj_productpublishingdetail_salesrights_List[b].obj_productpublishingdetail_salesrights_territory_List[c].obj_x450_List[d]))
                                    {
                                        territory = territory + product.obj_productpublishingdetail_List[a].obj_productpublishingdetail_salesrights_List[b].obj_productpublishingdetail_salesrights_territory_List[c].obj_x450_List[d].ToString() + " ";
                                    }
                                }
        ...
        //                            dr["RowCnt"] = (a + 1);
        //                            //dr["SalesRightsTypeCode_b089"] = product.obj_productpublishingdetail_List[a].obj_productpublishingdetail_salesrights_List[b].b089;
        //                            dr["NotForSale_b090"] = territory.Trim();
        //                            //dr["RightsTerritory_b388"] = "";
        ...
        //                string b012 = product.obj_productdescriptivedetail_List[a].obj_b012_product_descriptivedetail_List[b].ToString().ToLower();
        //                if (b012 == "ed")
        //                {
