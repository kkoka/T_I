...
namespace TitleInjestion.Company.RecordedBooks.Onix_2_Reference_Definiton
{
    public class Product_SupplyDetail_Price_DiscountCoded
    {
        ...
        public string DiscountCode_Product_SupplyDetail_Price_DiscountCoded { get; set; }
    
             
        [XmlElement("DiscountCodeType", IsNullable = true)]
        public string DiscountCodeType_Product_SupplyDetail_Price_DiscountCoded { get; set; }
