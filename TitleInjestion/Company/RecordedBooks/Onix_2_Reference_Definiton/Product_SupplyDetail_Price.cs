...
namespace TitleInjestion.Company.RecordedBooks.Onix_2_Reference_Definiton
{
    public class Product_SupplyDetail_Price
    {
        ...
        public List<string> obj_CountryCode_ProductSupplyDetailPrice_List = new List<string>();
        ...
        public List<Product_SupplyDetail_Price_DiscountCoded> obj_productSupplyDetailPrice_DiscountCoded_List = new List<Product_SupplyDetail_Price_DiscountCoded>();
