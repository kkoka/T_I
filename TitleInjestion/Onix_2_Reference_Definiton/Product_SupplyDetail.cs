...
namespace TitleInjestion.Onix_2_Reference_Definiton
{
    public class Product_SupplyDetail
    {
        ...
        public List<Product_SupplyDetail_Price> obj_ProductSupplyDetailPrice_List = new List<Product_SupplyDetail_Price>();
        ...
        public List<Product_SupplyDetail_Stock> obj_ProductSupplyDetailStock_List = new List<Product_SupplyDetail_Stock>();
